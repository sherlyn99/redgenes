...
from redgenes.sql_initialize_db import get_patch_list
from redgenes.exceptions import PatchDirectoryNotFound


class TestGeneAnnotations(TestCase):
    def test_get_patch_list(self):
        ...
        self.assertRaises(PatchDirectoryNotFound, get_patch_list, "tmp_patch123_dir")
